...
def create_pasha_rung_system(mode='max', epsilon=1.0, epsilon_scaling=1.0, ranking_criterion='soft_ranking'):
    ...
    promote_quantiles = [0.3333333333333333, 0.3333333333333333,
                         0.3333333333333333, 0.3333333333333333, 0.405]
    metric = 'objective'
    resource_attr = 'epoch'
    max_t = 200

    pasha_rung_rystem = PASHARungSystem(rung_levels, promote_quantiles, metric, mode,
...
def test_resources_increase():
    ...
    tworankings = [[('0', 0, 10.0), ('1', 3, 19.6), ('2', 2, 14.3), ('3', 1, 11.6)],
    ...
    tworankings = [[('0', 0, 10.0), ('1', 1, 11.55), ('2', 3, 14.3), ('3', 2, 11.6)],
                   [('0', 0, 10.1), ('1', 3, 19.7), ('2', 2, 14.2), ('3', 1, 11.5)]]
...
def test_soft_ranking_criterion():
    ...
    pasha_rung_system = create_pasha_rung_system(
        mode='min', epsilon=0.3)
    rankings = [[('0', 0, 10.0), ('1', 3, 19.6), ('2', 2, 14.3), ('3', 1, 11.6)],
                [('0', 0, 10.1), ('1', 3, 19.7), ('2', 2, 14.2), ('3', 1, 11.5)]]
    ...
    rankings = [[('0', 0, 10.0), ('1', 3, 14.6), ('2', 2, 14.3), ('3', 1, 11.6)],

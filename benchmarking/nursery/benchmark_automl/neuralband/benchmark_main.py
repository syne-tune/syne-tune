...
from benchmarking.nursery.benchmark_automl.neuralband.baselines import MethodArguments, methods
...
if __name__ == "__main__":
    ...
    #benchmark_names = ["nas201-ImageNet16-120"]

...
from syne_tune.optimizer.schedulers.neuralband.NeuralBand import NeuralbandScheduler
from syne_tune.optimizer.schedulers.neuralband.NeuralBand_UCB import NeuralbandUCBScheduler
from syne_tune.optimizer.schedulers.neuralband.NeuralBand_TS import NeuralbandTSScheduler
#from syne_tune.optimizer.schedulers.neuralband.NeuralBandSH import NeuralbandSHScheduler
...
methods = {
    ...
    Methods.NeuralBandHP: lambda method_arguments: NeuralbandScheduler(
        gamma = 0.04,
        nu = 0.02,
        max_while_loop = 50,
        step_size = 5,
...
'''
    ...
    Methods.NeuralBand: lambda method_arguments: NeuralbandScheduler(
        gamma = 0.1,
        nu = 0.1,
        max_while_loop = 70,
        step_size = 5,

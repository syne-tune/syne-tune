...
from sagemaker_tune.optimizer.schedulers.searchers.bayesopt.gpautograd.gp_model \
...
from sagemaker_tune.optimizer.schedulers.searchers.bayesopt.gpautograd.optimization_utils \

...
- `extra`: Includes all additional dependencies for advanced features such as [blackbox-repository](https://github.com/syne-tune/syne-tune/blob/main/syne_tune/blackbox_repository/README.md), [YAHPO Gym](https://github.com/slds-lmu/yahpo_gym), or [BoTorch](https://github.com/pytorch/botorch).
